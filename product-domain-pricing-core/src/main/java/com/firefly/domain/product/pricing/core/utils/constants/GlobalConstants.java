...
public class GlobalConstants {
    ...
    public static final String CTX_PRODUCT_SUBTYPE_ID = "productSubtypeId";
    ...
    public static final String CTX_PRODUCT_PRICING_LOCALIZATION_ID = "productPricingLocalizationId";
